...
const RecipeController = {
  showRecipe: async (req, res, next) => {
    try {
      ...
      return res
        .status(200)
        .json({ code: 200, message: "Success showRecipe", data: result });
    } catch (err) {
  ...
  showRecipeById: async (req, res, next) => {
    try {
      ...
      return res
        .status(404)
        .json({ code: 404, message: "Failed showRecipeByIdcipe" });
    }
  },
  ...
  showRecipeByUserId: async (req, res, next) => {
    try {
      ...
      return res
        .status(404)
        .json({ code: 404, message: "Failed showRecipeByUserId" });
    }
  },
  ...
  updateRecipe: async (req, res, next) => {
    try {
      ...
      if (req.payload.id !== newRecipe.user_id) {
        ...
        return res
          .status(404)
          .json({ code: 404, message: "This is not your recipe" });
      }
